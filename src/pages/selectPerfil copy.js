...
async function selectPerfil() {
  ...
  const lideranca = await axios
    .get(`/api/consultaLideranca`)
    .then((res) => res.data);
  console.log(lideranca);
  const rolMembros = await axios
    .get(`/api/consultaMembros`)
    .then((res) => res.data);
  const celulas = await axios
    .get(`/api/consultaCelulas`)
    .then((res) => res.data);
  const userIgrejas = await axios
    .get(`/api/consultaIgreja`)
    .then((res) => res.data);
...
export async function getInitialProps() {
  console.log('agora vai getServerSideProps');
