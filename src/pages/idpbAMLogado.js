...
import { IdpbAM } from 'src/components/Logado/Comum/idpbAM';
...
function IdpbAMHome({ org }) {
  const router = useRouter();
  const { perfilUser } = router.query;
  return <IdpbAM item={org} title="SISTEMA-IDPB" perfilUser={perfilUser} />;
}
