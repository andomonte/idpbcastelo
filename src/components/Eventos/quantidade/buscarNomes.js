...
function BuscarNomes({ inscritos, setListaInscritos }) {
  ...
  if (inscritos === 'error') return <div>Erro ao acessar o Banco.</div>;
  if (!inscritos) return <div>Carregando ...</div>;
