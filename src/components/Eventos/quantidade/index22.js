...
const useStyles = makeStyles((theme) => ({
  ...
  contentShiftMain: {
    ...
    // comando para recolher a tela quando o drawer é aberto
  ...
  tabPanel: {
    flexGrow: 1,
    backgroundColor: theme.palette.background.idpb, // '#000', // theme.palette.background.default,
