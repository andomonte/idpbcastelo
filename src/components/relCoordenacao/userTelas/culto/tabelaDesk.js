...
export default function TabelaDesk({
  dadosRel,
  regiaoSelect,
  mes,
  statusDrawer,
  ...
  const url = `${window.location.origin}/api/consultaRIgreja/${regiaoSelect}`;
  ...
  const body = (
    <Box className={classes.paper}>
      <StyledTableContainer component={Paper}>
        ...
        <Box m={2} mt={2}>
          Oferta do Mês Atual: <strong> R$ {ofertaMes.toFixed(0)} </strong>
        </Box>
        <Box m={2} mt={2}>
          Oferta do Mês Anterior:{' '}
          <strong>R$ {ofertaMesAnterior.toFixed(0)} </strong>
        </Box>
        <Divider />
        <Box m={2} mt={2}>
          Dízimo do Mês Atual: <strong> R$ {dizimoMes.toFixed(0)} </strong>
        </Box>
        <Box m={2} mt={2}>
          Dízimo do Mês Anterior:{' '}
          <strong> R$ {dizimoMesAnterior.toFixed(0)} </strong>
        </Box>
      </StyledTableContainer>
