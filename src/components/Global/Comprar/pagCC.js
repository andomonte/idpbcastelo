...
function PagCC({ email, cpf }) {
  ...
  let installmentsE = '';
  const transactionAmountE = 50;
  const descriptionE = 'Inscrição Global';
  let paymentMethodIdE = '';
  const emailE = email;
  let issuerE = '';
  let docTypeE = '';
  const docNumberE = cpf;
  let tokenE;
          ...
          <Box>
            ...
            <Box className={classes.novoBox} mt={-2}>
              <select
                ...
                type="text"
                onChange={(e) => {
                  docTypeE = e.target.value;
                  console.log(docTypeE);
                }}
                onFocus={(e) => (docTypeE = e.target.value)}
              />
            </Box>
          </Box>
          <Box display="none">
        ...
        <Box>
          ...
          <Box className={classes.novoBox} mt={-2}>
            <select
              ...
              onChange={(e) => (issuerE = e.target.value)}
              onFocus={(e) => (issuerE = e.target.value)}
            />
          </Box>
        </Box>
        <Box>
          ...
          <Box className={classes.novoBox} mt={-2}>
            <select
              ...
              id="installments"
              name="installments"
              onChange={(e) => (installmentsE = e.target.value)}
              onFocus={(e) => (installmentsE = e.target.value)}
            />
          </Box>
          {console.log('banco:', installmentsE, email)}
        </Box>
