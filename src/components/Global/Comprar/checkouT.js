          ...
          <Box>
            ...
            <Box display="flex" mt={0.5}>
              <Grid item xs={7} md={3}>
                ...
                <Box className={classes.novoBox} mt={-2} mr={1.8}>
                  <input
                    type="text"
            ...
            <Box display="flex" mt={0.5}>
              <Grid item xs={5} md={3}>
                ...
                <Box className={classes.novoBox} mt={-2} ml={-0.2}>
            ...
            <Box className={classes.novoBox} width="99.2%" mt={-2} ml={0.3}>
              <select
