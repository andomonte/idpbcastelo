          ...
          <Box width="80vw">
            <Box mt={0} fontSize="11px" fontFamily="Fugaz One">
              <Box width="100%" display="flex">
                <Box width="100%"> ENTREGA INDIVIDUAL DE CADA RELATÓRIO:</Box>
              </Box>
            ...
            <Box mt={2} fontSize="11px" fontFamily="Fugaz One">
              <Box width="100%" display="flex">
                <Box width="100%"> PONTUALIDADE NA ENTREGA DOS RELATÓRIOS:</Box>
              </Box>
      ...
      <AccordionItem>
        ...
        <AccordionItemPanel>
          <Box width="80vw">
            <Box mt={0} fontSize="11px" fontFamily="Fugaz One">
              <Box width="100%" display="flex">
                <Box width="100%">PARTICIPAÇÃO DA CELEBRAÇÃO NA IGREJA:</Box>
              </Box>
              <Box fontFamily="arial" color="#6a1b9a" fontSize="14px">
                Percentual de Presentes / 10 (maximo 10 pts)
              </Box>
